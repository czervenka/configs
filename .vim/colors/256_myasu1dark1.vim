...
hi Normal       cterm=NONE     ctermfg=255    ctermbg=233 guifg=#c0c0c0 guibg=#080808
hi NonText      cterm=bold     ctermfg=240 guibg=#0F0F0F
hi Function     cterm=BOLD     ctermfg=117   ctermbg=233 guifg=#f6f27f gui=bold

hi Statement    cterm=BOLD     ctermfg=11    ctermbg=233 guifg=#edea8e

hi Special      cterm=NONE     ctermfg=14    ctermbg=233
" tabulatory, prebytecne mezery, apod
hi SpecialKey   cterm=BOLD     ctermbg=16    ctermfg=240 guibg=#18130f
